...
class Dealership:
    ...
    def add_cars(self, cars):
        for car in cars:
            self.car_list.append(Car(car[0], car[1], car[2], CarAttributes(car[3], car[4], car[5])))
    ...
    def update_car(self, id, new_value):
        for car in self.car_list:
            if car.id == id:
                if new_value[0] == 'brand':
                    car.brand = new_value[1]
                    return 'Updated'
                elif new_value[0] == 'price':
                    car.price = new_value[1]
                    return 'Updated'
                elif new_value[0] == 'paint':
                    car.attributes.paint = new_value[1]
                    return 'Updated'
                elif new_value[0] == 'tires':
                    car.attributes.tires = new_value[1]
                    return 'Updated'
                elif new_value[0] == 'trim':
